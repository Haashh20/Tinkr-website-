              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input required type="text" className="w-full bg-white border border-border-subtle rounded-xl px-4 py-3 outline-none focus:border-tinkr-yellow transition-colors" placeholder="Jane" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-semibold">Last Name *</label>
                    <input required type="text" className="w-full bg-white border border-border-subtle rounded-xl px-4 py-3 outline-none focus:border-tinkr-yellow transition-colors" placeholder="Doe" />
                  </div>
                </div>
                
                <div className="space-y-2">
                  <label className="text-sm font-semibold">Company Name *</label>
                  <input required type="text" className="w-full bg-white border border-border-subtle rounded-xl px-4 py-3 outline-none focus:border-tinkr-yellow transition-colors" placeholder="Acme Corp" />
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-semibold">Work Email *</label>
                  <input required type="email" className="w-full bg-white border border-border-subtle rounded-xl px-4 py-3 outline-none focus:border-tinkr-yellow transition-colors" placeholder="jane@acmecorp.com" />
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-semibold">How can we help? *</label>
                  <textarea required rows={4} className="w-full bg-white border border-border-subtle rounded-xl px-4 py-3 outline-none focus:border-tinkr-yellow transition-colors resize-none" placeholder="Tell us about your team size, goals, and preferred dates..."></textarea>
                </div>
